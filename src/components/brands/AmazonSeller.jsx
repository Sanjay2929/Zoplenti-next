  ...
  return (
    <div className="pb-[60px] sm:pb-20 md:pb-[100px] lg:pb-[120px] relative z-20">
      ...
      {sellAmazonList.map((obj, i) => (
        <div
          key={i}
          className={`border-t border-dodgerBlue py-4 lg:py-[60px] sm:py-[34px] ${
            i === 3 ? "bg-dodgerBlue" : "sell_amazon_bg"
          }`}>
          ...
          <div className="container md:px-12 xl:px-3 max-w-[1140px] px-4 sm:px-8 mx-auto relative">
            ...
            <p
              className={`text-white pt-[18px] font-aeoniktrials font-normal text-sm sm:text-base md:text-lg lg:text-xl !leading-[170%] pe-8 min-[430px]:pe-0 ${
                i === 3 ? "max-w-[1119px]" : "max-w-[1077px]"
              }`}>
              {obj.content}
            </p>
          </div>
